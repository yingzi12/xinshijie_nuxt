...
selectWorldName.value=route.query.selectWorldName;
...
if(selectWorldName.value != null && selectWorldName.value != undefined){
  queryParams.value.name=selectWorldName.value
}
//查看详细
